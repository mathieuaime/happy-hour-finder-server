...
public class BarFacadeImplTest {
  ...
  public void findByIdWithEmptyResult() throws Exception {
    ...
    Optional<BarDto> barDto = mockBarFacade.findById(1L);

    assertThat(barDto).isNotPresent();
    verify(barService).findById(1L);
  }

  @Test
  public void findByIdWithResults() throws Exception {
    when(barService.findById(1L)).thenReturn(Optional.of(this.bar));
  ...
  public void deleteById() throws Exception {
    ...
    mockBarFacade.deleteById(1L);

    verify(barService).deleteById(1L);
  }
}
