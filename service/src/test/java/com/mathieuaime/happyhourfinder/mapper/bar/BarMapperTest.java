...
public class BarMapperTest {
  ...
  public void convertBarEntityToBarDto_shouldSucceed() {
    ...
    Bar bar = new Bar().id(1L).name("Bar1").coordinates(point).happyHour(happyHour);
  ...
  public void convertBarDtoToBarEntity_shouldSucceed() {
    ...
    BarDto barDto = new BarDto().id(1L).name("Bar1").coordinates(point).happyHour(happyHourDto);
